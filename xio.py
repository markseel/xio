...
if len(sys.argv) < 2: # Usage 1 - Show help message
    ...
    print "         Show this message, list MIDI device names and port numbers."
    print ""
    print "Usage 2: python xio.py <midi_port>"
    print "         Wait for properties to arrive from the attached device (for debugging)."
    print "         and print the propertie's data to the console."
    print ""
